...
# from .websocket import router as websocket_router  # ENWebSocketsystem
...
# from .environment import router as environment_router  # filedoes not exist，EN
...
# api_router.include_router(websocket_router, tags=["websocket"])  # ENWebSocketsystem
...
# api_router.include_router(environment_router, tags=["environment"])  # filedoes not exist，EN
